...
export function printReceipt({ sale, items, customerName, customerPhone }) {
  ...
  receiptWindow.document.write(`<!doctype html>
    <html><head><title>Receipt ${escapeHtml(sale.invoice_number)}</title>
      ...
      <header><h1>MediFlow Pharmacy</h1><p class="muted">Point of Sale Receipt</p></header>
      <div class="rule"></div>
      ...
      <div class="rule"></div>
      <p class="center">Thank you for choosing MediFlow Pharmacy.</p>
